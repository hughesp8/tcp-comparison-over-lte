...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-PHwBoS/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-PHwBoS/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-PHwBoS/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'stats', 'socket', 'routing', 'udp', 'ipv6', 'naming', 'error-model', 'energy', 'tcp', 'tutorial', 'realtime', 'udp-client-server', 'wireless', 'matrix-topology']
...
NS3_EXECUTABLE_PATH = ['/home/paddyxvy/ns-allinone-3.30.1/ns-3.30.1/build/optimized/src/fd-net-device', '/home/paddyxvy/ns-allinone-3.30.1/ns-3.30.1/build/optimized/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/paddyxvy/ns-allinone-3.30.1/ns-3.30.1/build/optimized/lib']
...
VERSION = '3.30.1'
WITH_PYBINDGEN = '/home/paddyxvy/ns-allinone-3.30.1/pybindgen-0.20.0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/paddyxvy/ns-allinone-3.30.1/ns-3.30.1/build/optimized/ns3/config-store-config.h', '/home/paddyxvy/ns-allinone-3.30.1/ns-3.30.1/build/optimized/ns3/core-config.h']
cprogram_PATTERN = '%s'
