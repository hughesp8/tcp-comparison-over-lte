...
void GetPositionRaw (Ptr<Node> node)
{
...
static void TraceGoodput (std::string throughput_name)
{
  ...
  Config::ConnectWithoutContext("/NodeList/5/ApplicationList/0/$ns3::PacketSink/Rx", MakeCallback (&SinkRx));
}
...
int main (int argc, char *argv[])
{
  ...
  setPos (enbNodes.Get (0), 20, 50, 1.5);
  ...
  /*
  pointoToPointGateway.EnablePcap ("single_debug", internetDevices , false);
